# Lung Cancer Imaging AI

Production-style healthcare AI prototype for Thoracic oncology imaging.

## Use Case

Chest imaging decision support for benign, malignant, and normal lung case triage.
...
```bash
docker build -t lungcancerai .
docker run -p 8501:8501 lungcancerai
```
