...
Thoracic oncology imaging triage prototype with data manifests, model training, model comparison, Streamlit pages, Docker files, reports, and tests.

## Project Type

Python, Streamlit, and imaging ML prototype
...
Dataset archives were excluded. Use HEALTH_DATASET_ZIP or place datasets.zip under data/ for retraining.
...
- Friendly repository name: lung-cancer-ai
