...
Breast cancer malignancy prediction and clinical decision-support MVP with data validation, model comparison, explainability, dashboard pages, Docker files, and tests.

## Project Type

Python, Streamlit, and healthcare ML prototype
...
Virtual environments, logs, caches, and generated runtime outputs were excluded. This is an educational prototype, not a clinical tool.
...
- Friendly repository name: breast-cancer-ai
