...
Production-style healthcare AI prototype for Neuro-oncology imaging.

## Use Case

MRI triage support for identifying whether a brain scan shows tumour-suspicious findings.
...
```bash
docker build -t braintumourai .
docker run -p 8501:8501 braintumourai
```
