...
Clinical triage demonstration for brain tumor detection, with reproducible training, prediction services, reporting, Streamlit dashboard, Docker files, and tests.

## Project Type

Python, Streamlit, Docker, and clinical triage prototype
...
- Friendly repository name: brain-tumor-detection-system
