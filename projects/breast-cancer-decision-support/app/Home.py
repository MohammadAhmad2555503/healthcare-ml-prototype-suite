...
render_title(
    ...
    "A healthcare dashboard for malignancy risk prediction, model monitoring, and explainable clinical support.",
)
...
with left:
    ...
    st.write(
        "This MVP supports breast cancer diagnostic workflows by combining structured tumor measurements with a validated predictive modeling pipeline. "
