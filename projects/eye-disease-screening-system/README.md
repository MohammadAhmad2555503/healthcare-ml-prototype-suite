...
Clinical screening demonstration for eye disease categories, with reproducible training, prediction services, reporting, Streamlit dashboard, Docker files, and tests.

## Project Type

Python, Streamlit, Docker, and clinical screening prototype
...
- Friendly repository name: eye-disease-screening-system
