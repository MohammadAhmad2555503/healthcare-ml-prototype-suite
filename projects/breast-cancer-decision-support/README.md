...
Clinical decision-support demonstration for breast cancer prediction, with reproducible training, prediction services, reporting, Streamlit dashboard, Docker files, and tests.

## Project Type

Python, Streamlit, Docker, and clinical decision-support prototype
...
Runtime caches and logs were excluded. This is an educational prototype, not a clinical tool.
...
- Friendly repository name: breast-cancer-decision-support
