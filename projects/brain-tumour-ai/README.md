...
Neuro-oncology imaging triage prototype with data manifests, model training, model comparison, Streamlit pages, Docker files, reports, and tests.
...
- Friendly repository name: brain-tumour-ai
